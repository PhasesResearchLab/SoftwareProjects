...
- ✅ User-Ready / 🔬 Research-Ready / 🏗 Under Constructuon (Experimental)

## Active Development

- 🟢 ✅ [pySIPFENN](https://github.com/PhasesResearchLab/pySIPFENN) - py(**S**tructure-**I**nformed **P**rediction of **F**ormation **E**nergy using **N**eural **N**etworks) 
...
- Please limit the description to 3 lines of text and badges.
